...
- (IBAction)rechargeAction:(id)sender {
    ...
    [service loadCreatePayOrderInfoWithMid:userModel.mid andPrice:self.price.text finished:^(Create_pay_orderInfo *model){
...
-(NSString*)getOrderInfoWithCreate_pay_orderInfo:(Create_pay_orderInfo *)model andPrice:(NSString *)price
{
    ...
    order.productName = [NSString stringWithFormat:@"%@在线充值",userModel.nickname]; //商品标题
